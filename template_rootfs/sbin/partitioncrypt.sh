...
echo "Setting up Full Disk Encryption for $CONFIG"
echo -n pass0 | cryptsetup --type luks2 --label CONFIG luksFormat $CONFIG -
echo "pass0" | cryptsetup luksOpen $CONFIG config -
echo "Formating $CONFIG" 
mkfs.ext4 -L CONFIG /dev/mapper/config
echo "Closing $CONFIG" 
cryptsetup luksClose config

echo "Setting up Full Disk Encryption for $DATA"
echo -n pass0 | cryptsetup --type luks2 --label DATA luksFormat $DATA -
echo "pass0" | cryptsetup luksOpen $DATA data -
echo "Formating $DATA"
